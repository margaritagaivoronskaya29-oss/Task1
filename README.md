...
* Реализована модель классификации, основанной на сверточных нейронных сетях (GoogLeNet),
  **точность ACC ≥ 0.95** на предоставленной тестовой выборке — **30 баллов**

**Дополнения:**

* Вывод показателей обучения (loss, val_acc) — **1 балл**
* Автоматическое сохранение лучшей модели — **1 балл**
* Автоматичесский выбор гиперпараметров модели во время обучения - **1-3 балл(ов)**
* Улучшения не из списка:

  * предобработка входных изображений (Resize, ToTensor, Normalize) — **1 балл**
  * автоматический выбор GPU/CPU — **1 балл**
